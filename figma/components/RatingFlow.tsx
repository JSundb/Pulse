...
import { X, Star, Upload, XCircle, Check } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'photos' && (
            ...
            >
              ...
              <p className="mb-4 text-gray-600">Share up to 4 photos</p>
              ...
              {photos.length < 4 && (
                <button
                  ...
                  className="mb-6 flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 py-12 text-gray-600 transition-all hover:border-blue-400 hover:bg-blue-50"
                >
                  <Upload size={24} />
                  <div className="text-left">
                    <p className="text-base text-gray-900">Upload photos</p>
