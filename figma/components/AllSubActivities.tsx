...
export default function AllSubActivities({ subActivities, onBack, onSelectSubActivity, onOpenUserProfile }: Props) {
            ...
            >
              ...
              {sub.owner && (
                <div className="mb-3 flex items-center gap-2">
                  ...
                  />
                  <span className="text-xs text-gray-500">Host: {sub.owner.name}</span>
                </div>
              )}
